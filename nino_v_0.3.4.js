...
*Add in 2013/7/8
*/
var randColor =function(_start,_end){
	var start=0;
	var end =0;
	var length=0;
	if(!_start)
...
var Debug = function debug(){
	...
	ml.style.color="#888";
	ml.innerHTML = "X:"+nino_mouse_x+" Y:"+nino_mouse_y;
	p.appendChild(ml);
 ...
 *Add in 2013/7/9
 */
var mouseCoordinate= function(event){
...
//document.onmousemove="mouseCoordinate(event)";
addListener("mousemove",mouseCoordinate,window);
/*
 *function drag()
 *@_fun  affter animate call function
 ...
 *Add in 2013/7/9
 */
var drag = function(_func1,_func2,_func3,event){
...
var removeDrag = function(_func1,_func2,_func3,event){
 ...
 *Add in 2013/7/10
 */
var showAlert = function(_content,_width,_height,_color){
	...
	div_tmp.dom.style.background=_color? _color:randColor();
 ...
 */
var showWindow = function(_content,_width,_height,_color){
	var windowCount=0;
	if(arguments.length==0)
	return;
	var w="500px";
	...
	//div_tmp.dom.setAttribute("window_left",nino_windowCount);
	var small = function(){
		...
		div_tmp.dom.style.left=nino_windowCount*250+"px";
